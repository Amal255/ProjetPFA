...
@Component({
  selector: 'app-figue-de-barbarie',
  templateUrl: './figue-de-barbarie.component.html',
  styleUrls: ['./figue-de-barbarie.component.css']
})
export class FigueDeBarbarieComponent implements OnInit {
  quantity: number = 1;
  productName: string = "Le soin miracle: L'huile de pépins de figue de barbarie";
  productPrice: number = 39.000;
  ...
  selectedImage: string = "../../assets/images/7.jpg";
  imageList: string[] = [
    "../../assets/images/Capture74.PNG",
    "../../assets/images/Capture2231.PNG",
    "../../assets/images/Capture994.PNG",
