...
@Component({
  selector: 'app-argan',
  templateUrl: './argan.component.html',
  styleUrls: ['./argan.component.css']
})
export class ArganComponent implements OnInit {
 

  quantity: number = 1;
  productName: string = "L'huile de RICIN; 30 ML";
  productPrice: number = 9.800;
  ...
  selectedImage: string = "../../assets/images/ricin3.jpg";
  imageList: string[] = [
    "../../assets/images/ricin1.jpg",
    "../../assets/images/ricin2.jpg",
    "../../assets/images/ricin4.jpg",
